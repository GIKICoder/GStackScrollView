...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of GStackScrollView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/GIKI/GStackScrollView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'GIKI' => '810373457@qq.com' }
  s.source           = { :git => 'https://github.com/GIKI/GStackScrollView.git', :tag => s.version.to_s }
